//
//  HGMainViewGlobalOccasionGiftCollectionGridViewItemView.m
//  HappyGift
//
...
@interface HGMainViewGlobalOccasionGiftCollectionGridViewItemView()
-(void)initSubViews;
@end


@implementation HGMainViewGlobalOccasionGiftCollectionGridViewItemView
@synthesize giftSet;
...
+ (HGMainViewGlobalOccasionGiftCollectionGridViewItemView*)mainViewGlobalOccasionGiftCollectionGridViewItemView{
    NSArray* nibViews = [[NSBundle mainBundle] loadNibNamed:@"HGMainViewGlobalOccasionGiftCollectionGridViewItemView"
                                                      owner:self
                                                    options:nil];
