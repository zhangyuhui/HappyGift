 ...
 */
#define RENREN_APP_ID     @"197668"
#define RENREN_APP_KEY    @"4014fdc0a0784573a0c49718e89e4914"
...
@class RenrenPay;
@class ROPhotoAddCommentRequestParam;
@class ROBlogAddCommentRequestParam;
@class ROStatusAddCommentRequestParam;
@class ROForwardStatusRequestParam;
@class ROShareRequestParam;

@interface RenrenService: NSObject <RODialogDelegate, RORequestDelegate> {
 ...
 */
- (void)renrenDialogDidCancel:(RenrenService *)renren;
/**
