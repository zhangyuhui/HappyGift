...
@implementation WeiBoDBConnection
...
+ (sqlite3*)getSharedDatabase
{
    if (theDatabase == nil) {
        ...
        if (theDatabase == nil) {
            [WeiBoDBConnection createEditableCopyOfDatabaseIfNeeded:true];
        }
...
{
    WeiBoDBStatement* stmt = [WeiBoDBStatement statementWithDB:theDatabase query:sql];
    return stmt;
}
